...
if uploaded_file is not None:
    ...
    # Filter (optional if using Kaggle ab_data.csv)
    # Remove this if you don't have 'landing_page' or 'user_id'
    ...
    z_score, p_value = stats.proportions_ztest(success, nobs)
